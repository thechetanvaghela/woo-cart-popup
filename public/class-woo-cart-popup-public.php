...
class Woo_Cart_Popup_Public {
	...
	public function enqueue_styles() {
		 ...
		 * class.
		 */
		wp_enqueue_style( 'wp-chat-bootstrap-min', plugin_dir_url( __FILE__ ) . 'css/bootstrap.min.css',array(), '20181230' );
	...
	public function enqueue_scripts() {
		 ...
		 * class.
		 */
		wp_enqueue_script( 'wp-chat-bootstrap-script',  plugin_dir_url( __FILE__ ) . 'js/bootstrap.min.js', array( 'jquery' ), '20181230', true );
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/woo-cart-popup-public.js', array( 'jquery' ), $this->version, false );
